...
backup = PROJECT / f"backup-v0.16.1-{stamp}"
...
shutil.copy2(
    Path(__file__).parent / "templates" / "admin_home.html",
    ADMIN_HOME,
)
shutil.copy2(
    Path(__file__).parent / "templates" / "admin_document_templates.html",
    ADMIN_TEMPLATES,
)
...
print("PLG Core v0.16.1 Administration and Templates installed successfully.")
