...
backup = PROJECT / f"backup-v0.10-{stamp}"
...
for rel in [
    ...
    shutil.copy2(PAYLOAD / rel, PROJECT / rel)

py_compile.compile(str(PROJECT / "app.py"), doraise=True)

print("PLG Core v0.10 Supplier Lists installed successfully.")
print(f"Backup created at: {backup}")
print("Your live database was preserved. Supplier history will populate from existing sources.")
