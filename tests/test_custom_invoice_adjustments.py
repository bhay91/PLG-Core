...
class CustomInvoiceAdjustmentTests(unittest.TestCase):
    ...
    def test_adjusted_pdf_filters_items_and_freight_but_standard_is_unchanged(self):
        ...
        self.assertNotIn("Service Charge", standard_body)
        self.assertNotIn("Sourcing Fee", standard_body)
        self.assertIn("$550.00", standard_body)
        self.assertIn("$600.00", standard_body)
